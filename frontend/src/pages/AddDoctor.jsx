        ...
        <div style={{ maxWidth: "980px", margin: "0 auto" }}>
          <div className="mb-4">
            <div className="d-flex align-items-center gap-2 mb-2 small">
              ...
              <span className="fw-semibold text-dark">Add New Doctor</span>
            </div>

            <h1 className="fw-bold mb-1">Add New Doctor</h1>
            <p className="text-muted mb-0">
              Create a new professional profile for a medical practitioner.
            </p>
          </div>
